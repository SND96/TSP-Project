...
class Plotter:
    ...
    def plot(self, X, Y, labels=None, xax_label=None, yax_label=None,
             ...
             save_path=None, xscale='log', linestyles = None):
        """
        params:
        ...
        for x, y, label, c, linestyle in zip(X, Y, labels, colors, linestyles):
            ax.plot(x, y, label=label, alpha=self.line_alpha,
                    linewidth=self.line_width, color=c, linestyle = linestyle)
